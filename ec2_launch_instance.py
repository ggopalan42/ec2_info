...
def launch_instance(ami='ami-1bd68a5e',
    ...
    # Note: Making implicit assumption that availability_zone is always
    # passed as xx-region-#[a|b|c|..]. If this format is not correct,
    # then this piece has to be re-written
    ...
    try:
        ...
        if e.code == 'InvalidKeyPair.NotFound':
            ...
            """ Giri: Don't create a new key-pair. Simply report it
    ...
    try:
        ...
        if e.code == 'InvalidGroup.NotFound':
            ...
            """ Giri: do not create a new security group. Just report it.
